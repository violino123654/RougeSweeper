...
public class Perder extends JFrame{
    ...
    public Perder(){
        ...
        ImageIcon fundoGif = new ImageIcon(getClass().getResource("/gifs/gif/Fundos/FundoPerder.gif"));
        JLabel background = new JLabel(fundoGif);

        ImageIcon imagem = new ImageIcon(getClass().getResource("/imagens/png/PerderTitulo.png"));
